...
#| eval: false
file_list_ketone <- dir_ls(gsub("\\\\", "/", r"(C:\UDP\Archive\Output_2023-11-02-13-54\outputs)"),recurse = T,glob = "*events.csv|*anaPlus.csv")
```
<!-- filter_path(file_path = file_list_ketone)[[1]] filter_path(file_path = file_list_ketone)[[5]] -->
```{r}
#| label: Ketone Filter events, anaPlus
#| eval: false
events_path_ketone <- file_list_ketone[str_detect(file_list_ketone,"events.csv")]
