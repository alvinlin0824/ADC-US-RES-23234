...
`r knitr::asis_output("CMDOSU(Units) should not be blank and should be character")` `r colorize(cm2[str_detect(cm2$CMDOSU,"^$|pattern|[:digit:]"),]$Subject,"red")`
...
str_detect(de$DESPID07,regex("Reader",ignore_case = T)) & str_length(de$DESPID01) != median(str_length(de$DESPID01),na.rm = T)        |
# Sensor
...
`r knitr::asis_output("Length of DESPID01(Reader serial number) should be")` `r colorize( median(str_length(de$DESPID01),na.rm = T),"red")` `r colorize(de[str_detect(de$DESPID07,regex("Reader",ignore_case = T)) & str_length(de$DESPID01) != median(str_length(de$DESPID01),na.rm = T),]$Subject,"red")`
...
du2[
# Device Type
!str_detect(du2$UPORES01,"Sensor|Other") | 
# If other, Other Type Specify
str_detect(du2$UPORES01,"Other") & str_detect(du2$UPTXT01,"^$|pattern") | 
# Sensor number
str_detect(du2$UPORES01,"Sensor") & str_length(du2$UPID01) != 1 |
...
`r knitr::asis_output("UPORES01(Device Type) should be either Sensor or Other")` `r colorize(du2[!str_detect(du2$UPORES01,"Sensor|Other"),]$Subject,"red")` `r knitr::asis_output("If UPORES01(Device Type) is Other, UPTXT01(Other Type Specify) should not be blank")` `r colorize(du2[str_detect(du2$UPORES01,"Other") & str_detect(du2$UPTXT01,"^$|pattern"),]$Subject,"red")`

`r knitr::asis_output("Length of UPID01(Sensor number) should be 1")` `r colorize(du2[str_detect(du2$UPORES01,"Sensor") & str_length(du2$UPID01) != 1,]$Subject,"red")`
...
ps$PSORES07 < quantile(ps$PSORES07,probs = 0.25,na.rm = T) - 1.5*(quantile(ps$PSORES07,probs = 0.75,na.rm = T) - quantile(ps$PSORES07,probs = 0.25,na.rm = T)) |
...
`r knitr::asis_output("Extreme PSORES07(Enter blood glucose level (mg/dL):)")` `r colorize(ps[ps$PSORES07 < quantile(ps$PSORES07,probs = 0.25,na.rm = T) - 1.5*(quantile(ps$PSORES07,probs = 0.75,na.rm = T) - quantile(ps$PSORES07,probs = 0.25,na.rm = T)),]$Subject,"red")`
...
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES01,regex("1=Poor|2=Average|3=Good",ignore_case = T)) |
# Cellulite score (C)
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES02,regex("1=Significant|2=Average|3=Minor",ignore_case = T)) |
# Fine Lines Wrinkles score (C)
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES03,regex("1=Significant|2=Average|3=Minor",ignore_case = T)) |
# Hair Coverage score (C)
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES04,"1=Significant\\(shaving required\\)|2=Non-significant") |
# Dry Skin score (C)
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES05,regex("1=Significant\\(Flaky\\)|1=Significant \\(Flaky\\)|2=Non-significant",ignore_case = T))  |
# Scabbing score (C)
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES06,regex("Yes|No",ignore_case = T))   |
# If Yes, Scabbing Area (cm2) (N)
str_detect(sk2$PEORES06,regex("Yes",ignore_case = T)) & is.na(sk2$PEORES07)             |
# Scarring score (C)
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES08,regex("Yes|No",ignore_case = T))                               |
...
!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES10,regex("Yes|No",ignore_case = T))                               |
...
`r knitr::asis_output("PEORES01(General skin tone score) should be 1=Poor,2=Average,3=Good")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES01,regex("1=Poor|2=Average|3=Good",ignore_case = T)),]$Subject,"red")`

`r knitr::asis_output("PEORES02(Cellulite score) should be 1=Significant, 2=Average, 3=Minor")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES02,regex("1=Significant|2=Average|3=Minor",ignore_case = T)),]$Subject,"red")`

`r knitr::asis_output("PEORES03(Fine Lines Wrinkles score) should be 1=Significant, 2=Average, 3=Minor")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES03,regex("1=Significant|2=Average|3=Minor",ignore_case = T)),]$Subject,"red")`

`r knitr::asis_output("PEORES04(Hair Coverage score) should be 1=Significant(shaving required), 2=Non-significant")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES04,"1=Significant\\(shaving required\\)|2=Non-significant"),]$Subject,"red")`

`r knitr::asis_output("PEORES05(Dry Skin score) should be 1=Significant(Flaky),2=Non-significant")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES05,regex("1=Significant\\(Flaky\\)|1=Significant \\(Flaky\\)|2=Non-significant",ignore_case = T)),]$Subject,"red")`

`r knitr::asis_output("PEORES06(Scabbing score) should be Yes or No")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES06,regex("Yes|No",ignore_case = T)),]$Subject,"red")`
...
`r knitr::asis_output("PEORES08(Scarring score) should be Yes or No")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES08,regex("Yes|No",ignore_case = T)),]$Subject,"red")`
...
`r knitr::asis_output("PEORES010(Hypo/Hyperpigmentation score) should be Yes or No")` `r colorize(sk2[!str_detect(sk2$PESTAT01,"ND") & !str_detect(sk2$PEORES10,regex("Yes|No",ignore_case = T)),]$Subject,"red")`
