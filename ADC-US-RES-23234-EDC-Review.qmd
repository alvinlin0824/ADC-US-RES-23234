...
`r htmltools::a("Adverse Event Report",href = gsub("\\\\", "/", r"(\\oneabbott.com\dept\ADC\Technical_OPS\Clinical_Affairs\Clinical Study Files\Apollo\ADC-US-RES-23234_IDE Pump Suspension Study\Case Report Forms\Version B\Approved\pdf\AE_Report.pdf)"))`
...
str_detect(cad2$DSORES01,regex("Not Applicable")) & str_detect(cad2$DSORES02,"^$|pattern") |
...
`r knitr::asis_output("If DSORES01(Urine Pregnancy Test Result:) is Not Applicable, DSORES02(Please check one of the reasons:) should not be blank")` `r colorize(cad2[str_detect(cad2$DSORES01,regex("Not Applicable")) & str_detect(cad2$DSORES02,"^$|pattern"),]$Subject,"red")`
